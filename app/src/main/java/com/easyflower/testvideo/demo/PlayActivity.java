package com.easyflower.testvideo.demo;
...
//            SysUtils.setBrightness(this, mCurrentLight);
    ...
    protected void initView() {
        ...
        Log.e(TAG, ">> url " + mUrl + ", mStreamType " + mStreamType);
        ...
        mVideoView.setOnInfoListener(new IMediaPlayer.OnInfoListener() {
            ...
            public boolean onInfo(IMediaPlayer mp, int what, int extra) {
                ...
                for (int i = 0; i < trackInfo.length; i++) {
                    ...
                    LogUtil.show(" ---------------- trackInfo = " + trackInfo[i].getLanguage());
                    LogUtil.show(" ---------------- trackInfo = " + trackInfo[i].getInfoInline());
                    LogUtil.show(" ---------------- trackInfo = " + trackInfo[i].getTrackType());
                    LogUtil.show(" ---------------- trackInfo = " + trackInfo[i].getFormat());

                    LogUtil.show(" ---------------- trackInfo = ");

                }

                LogUtil.show(" ---------------- mp.getMediaInfo(). = " + mp.getMediaInfo().mAudioDecoder);
                LogUtil.show(" ---------------- mp.getMediaInfo(). = " + mp.getMediaInfo().mAudioDecoderImpl);
                LogUtil.show(" ---------------- mp.getMediaInfo(). = " + mp.getMediaInfo().mMediaPlayerName);
                LogUtil.show(" ---------------- mp.getMediaInfo(). = " + mp.getMediaInfo().mVideoDecoder);
                LogUtil.show(" ---------------- mp.getMediaInfo(). = " + mp.getMediaInfo().mVideoDecoderImpl);
...
//        }
    ...
    public void setFullScreenOnly(boolean fullScreenOnly) {
        ...
        if (fullScreenOnly) {
            ...
            PlayActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
        }
    }

    private void tryFullScreen(boolean fullScreen) {
        if (PlayActivity.this instanceof AppCompatActivity) {
            ActionBar supportActionBar = ((AppCompatActivity) PlayActivity.this).getSupportActionBar();

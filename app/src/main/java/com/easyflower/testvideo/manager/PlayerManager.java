package com.easyflower.testvideo.manager;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity, ActionBar actionBar) {
        try {
...
//                      Toast.show("download rate:" + extra);
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus == STATUS_COMPLETED) {
            System.out.println("------------- statusChange STATUS_COMPLETED...");
            if (playerStateListener != null) {
                playerStateListener.onComplete();
            }
        } else if (newStatus == STATUS_ERROR) {
            System.out.println("------------- statusChange STATUS_ERROR...");
            if (playerStateListener != null) {
...
//            $.id(R.id.app_video_loading).visible();
            ...
            System.out.println("------------- statusChange STATUS_LOADING...");
        } else if (newStatus == STATUS_PLAYING) {
            System.out.println("------------- statusChange STATUS_PLAYING...");
            if (playerStateListener != null) {
    ...
    private void onVolumeSlide(float percent) {
        ...
        System.out.println("-------------onVolumeSlide:" + s);
    }
    ...
    private void onProgressSlide(float percent) {
        ...
        if (showDelta != 0) {
            ...
            System.out.println("-------------onProgressSlide:" + text);
        }
    }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        System.out.println("------------- brightness:" + brightness + ",percent:" + percent);

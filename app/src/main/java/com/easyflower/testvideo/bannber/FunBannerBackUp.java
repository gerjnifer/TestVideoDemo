...
public class FunBannerBackUp extends FrameLayout implements OnPageChangeListener {
    ...
    public FunBannerBackUp(Context context) {
        this(context, null);
    }

    public FunBannerBackUp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FunBannerBackUp(Context context, AttributeSet attrs, int defStyle) {
    ...
    public FunBannerBackUp isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public FunBannerBackUp setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public FunBannerBackUp setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public FunBannerBackUp setIndicatorGravity(int type) {
        switch (type) {
    ...
    public FunBannerBackUp setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public FunBannerBackUp setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public FunBannerBackUp setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public FunBannerBackUp setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public FunBannerBackUp setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public FunBannerBackUp setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public FunBannerBackUp setImages(List<?> imageUrls) {
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    @Deprecated
    public FunBannerBackUp setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public FunBannerBackUp setOnBannerListener(OnBannerListener listener) {
